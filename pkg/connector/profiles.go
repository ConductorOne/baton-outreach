...
func (b *profileBuilder) List(ctx context.Context, _ *v2.ResourceId, attr rs.SyncOpAttrs) ([]*v2.Resource, *rs.SyncOpResults, error) {
	var (
	...
	bag, nextPage, err := client.GetToken(token, &v2.ResourceId{ResourceType: profileResourceType.Id})
	if err != nil {
		return nil, nil, err
	}
	...
	return profileResources, &rs.SyncOpResults{
		Annotations:   outAnnotations,
		NextPageToken: nextPageToken,
	}, nil
}

func (b *profileBuilder) Entitlements(_ context.Context, resource *v2.Resource, _ rs.SyncOpAttrs) ([]*v2.Entitlement, *rs.SyncOpResults, error) {
	...
	return []*v2.Entitlement{entitlement.NewPermissionEntitlement(resource, profilePermissionName, assigmentOptions...)},
		&rs.SyncOpResults{
			Annotations: outAnnotations,
		}, nil
}
...
func (b *profileBuilder) Grants(_ context.Context, _ *v2.Resource, _ rs.SyncOpAttrs) ([]*v2.Grant, *rs.SyncOpResults, error) {
	return nil, nil, nil
}
